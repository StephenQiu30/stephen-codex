...
4. `.codex/skills/` 中存在 `agent-browser`、`harness-local-server`、`harness-playwright-evidence`、`harness-linear-loop` 和 `debug`，用于补齐浏览器自动化、本地启动、浏览器证据、Linear 闭环和 Symphony 排障。

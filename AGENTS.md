...
5. 每次使用 OpenSpec 执行完一个较大的 change 后，应使用中文 Git 提交信息进行提交，保持 change 完成后的工作区干净。
...
7. `docs/TEMPLATE.md` 是正式文档模板，新增 PRD、计划、设计、验收或运维文档时应优先复用。
8. 每个 docs 子目录必须有 README，说明该目录放什么、不放什么，以及文档命名建议。
...
1. 每次完成较大的 OpenSpec change 后，应先完成验证，再使用中文 Git 提交信息提交本次改动。
